...
Route::middleware('isSeller')->group(function(){
    ...
    Route::post('/update-status', [OrderController::class, 'update'])->name('update-status');
    ...
    Route::get('/fire-deliverer-{id}', [DelivererController::class, 'stopCollaborationWithDeliverer'])->name('stop-deliverer-collaboration');
    Route::post('/add-deliverer', [DelivererController::class, 'addDeliverer'])->name('add-deliverer');
    Route::post('/hire-deliverer', [DelivererController::class, 'requestToDeliverer'])->name('request-deliverer');
});
